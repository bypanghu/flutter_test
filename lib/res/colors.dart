...
class Colours {
  static const Color app_main = Color(0xFF19CF9C);
  static const Color dark_app_main = Color(0xFF44D7B6);
  ...
  static const Color button_disabled = Color(0xFF2A8672);
  static const Color dark_button_disabled = Color(0xFF378271);
